    ...
    <div class="wrapper">
       <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href=""><i class="bi bi-people-fill"></i>Club Members</a></li>
                ...
                <li class="active"><a href=""><i class="bi bi-person-circle"></i>Edit My Profile</a></li>
            </ul>
       </div>
      ...
      <div class="edit-profile-container">
        ...
        <div class="div1">
          <div class="profile-image">
            <img src="assets/images/player1.jpg" alt="" height="150" width="150">
          </div>
          <div class="div2">
            <h5>*Status* of</h5>
            <!-- form -->
