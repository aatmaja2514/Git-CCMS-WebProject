...
<body>
   ...
   <div class="wrapper">
       <div class="sidebar" id="challenge">
            <div class="clublogo">
       ...
       <div class="challenge-container">
          <div class="challenge-menu"> 
            <div onclick="window.location.href='challenge.html'">Challenge Clubs</div>
            <div class="divider"></div>
            <div class="active" onclick="window.location.href='challenge_requests.html'"> View Requests</div>
          </div>
          <div class="challenge-content">
            <div class="challenge-club">
              
            </div>
            <div class="challenge-req">
