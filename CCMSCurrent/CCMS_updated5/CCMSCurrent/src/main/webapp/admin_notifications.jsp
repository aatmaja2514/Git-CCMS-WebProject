    ...
    <div class="wrapper">
       <div class="sidebar">
            ...
            <div class="admin-noti">
                ...
                <div class="tabs">
                <div class="active" onclick="window.location.href='member_notifications.html'" >Add Club Requests</div>
                ...
                <div class="noti-content">
                    <table class="table table-sm table-dark">
                        ...
                        ResultSet rs = st.executeQuery("SELECT * FROM notifications_admin ORDER BY Notification_No DESC");
                        while(rs.next())
                        {
                        %>
                          <tr>
