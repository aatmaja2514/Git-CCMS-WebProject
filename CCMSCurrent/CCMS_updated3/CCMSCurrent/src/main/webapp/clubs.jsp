...
<body>
  ...
  %>
    ...
    <div class="search-bar" data-aos="fade-up">
      <input type="text" placeholder="Explore Clubs ..." name = "search">
      ...
      String search = request.getParameter("search");
    	  ...
    	  ResultSet rs1 = st1.executeQuery("SELECT * FROM clubs WHERE Club_No LIKE '%" + search + "%' OR Club_Name LIKE '%" + search + "%' OR club_desc LIKE '%" + search + "%'");
          while(rs1.next())
          {%>
      ...
      <div class="container club-container" data-aos="fade-up" data-aos-delay="200">
        <div class="row">
          ...
          <div class="col-lg-6 about-img"><br>
            <img src="assets/images/logo1-removebg.png" alt="clublogoimg" height="200">
          </div>
          ...
          <div class="col-md-6 about-content"><br>
            ...
            <p class="about-text">
				...
				String h = "Select Coach_Name From coach Where Club_Id = '"+ rs.getString(2) + "' AND Status = 'Head'";
				ResultSet r1 = s.executeQuery(h);
				if(r1.next())
				{
				%>           
              Head Coach - <%= r1.getString(1) %>
              <%} %>
            </p>
              <a href="#login" class="joinbtn">join</a>
              <a href="#login" class="joinbtn">View</a>
          </div>
