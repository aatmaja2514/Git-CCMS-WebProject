          ...
          <div class="challenge-content">
			...
			%>
             ...
             <div class="div4">
                ...
                <h6><i>
					Note: Challenge Request will be sent to all team members you select and only 15 team members who accept first will be taken for match. You can choose to swap a team member with club member only for this match or edit team list.
                </i></h6>
