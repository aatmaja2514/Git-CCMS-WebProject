	...
	<div class="wrapper">
		<div class="sidebar">
			...
			<ul>
				...
				<li><a href="clubs.jsp"><i class="bi bi-filter-square-fill"></i>All Clubs</a></li>
			...
			<div class="admin-profile">
				<div class="admin-profile-container">
					...
					<div class="post-noti-admin">
						<textarea name="" id="" placeholder="Type message to post ..."></textarea>
					...
					<div class="admin-info">
						<dl class="row">
							...
							<dd class="col-sm-6"><%=rs.getString(7)%></dd>
							<%
							}
							%>
						</dl>
						<a href="admin_profile.jsp"><button
								class="edit-admin-profile-btn">EDIT</button></a>
					</div>
						...
						<table class="table table-dark table-borderless">
							...
							while (rs3.next()) 
							{
								for (int i = 1; i <= rs3.getInt(1); i++) 
								{
									...
									ResultSet rs1 = st1.executeQuery("Select Club_Id,Club_Name, Max_Capacity from clubs");
