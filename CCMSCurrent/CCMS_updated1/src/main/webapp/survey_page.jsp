...
<body>
  ...
  <div class="survey-page-container">
    ...
    <div class="div1">
        ...
        <div class="contents">
            <form action="">
                <label for="inputPassword5" class="form-label">What is your favourite color ?</label>
                <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock"><br>
            ...
            <div class="survey-info">
              <i class="bi bi-info-circle"></i>  Remember your entries for further refrences.
            </div>
