    ...
    <div class="div1">
        ...
        <div class="contents">
            ...
            <form action="survey_page_operations.jsp" method="POST">
                ...
                <input type="password" name="inputcolor" class="form-control" aria-describedby="passwordHelpBlock"><br>

                <label for="inputPassword5" class="form-label">What did you name your first pet ?</label>
                <input type="password" name="inputpet" class="form-control" aria-describedby="passwordHelpBlock"><br>
