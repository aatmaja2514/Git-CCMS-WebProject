   ...
   <div class="wrapper">
            		 ...
            		 */
             		...
             		Statement st4 = con.createStatement();
                      ...
                      <% }
                        ...
                        {%>
                        	<td><button type="submit" name = "add_to_team"><a href = "team_operations.jsp?add_id=<%= rs4.getString(7) %>"><i class="bi bi-check-lg"></i> Add</a></button></td>
                			<td>Not in Team</td>
                			<td><button type="submit"><a href = "team_operations.jsp?del_member_id=<%= rs4.getString(7) %>"><i class="bi bi-dash-circle"></i></a></button></td>
                        <%}
	...
	<%-- function confirmation()
	{
		if(confirm("Are you sure you want to remove") == true)
			{
				<% response.sendRedirect("team_operations.jsp?del_member_id=<%= rs4.getString(7)"); %>
			}
	}
	</script>
