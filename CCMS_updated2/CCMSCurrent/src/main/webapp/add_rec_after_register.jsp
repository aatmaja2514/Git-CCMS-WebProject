...
<%
  ...
  %>
          ...
          try
        {
            ...
            //ResultSet rs1 = st1.executeQuery("Select Club_Id FROM clubs WHERE Club_Name = '" + request.getParameter("clubname") + "'");
            //while(rs1.next())
            //{
           	//	rs1.getString(1);
            //}
        	...
        	if(club_session != null && fname != null && mail != null && contact != null &&  age != null && status != null && pass != null && re_pass != null)
        	{
        	  	...
        	  	{%> 
        	  		...
        	  		alert("User already exists");
        	  		 response.sendRedirect("login.jsp");
        	  			...
        	  			document.getElementById("reg-error").innerHTML = "User already exists."; */
        	  		</script>
              ...
              {%> 
        	  		...
        	  		response.sendRedirect("login.jsp");
        	  			/* document.getElementById("reg-error").innerHTML = "Passwords doesn't match. Please try again."; */
        	  		</script>
        	  	<%}
              else
        	  	{
		        		if(rs2.next())
		        		{
				        	...
				        	String insert_query = "INSERT INTO member(Club_Id, Session_Id,Full_name,Email, Contact, Age, Interested_Status, Password, Status) VALUES (?,?,?,?,?,?,?,?,'M')";
