    ...
    <div class="wrapper">
       <div class="sidebar">
            ...
            <div class="admin-noti">
                <div class="tabs">
                  <div class="active" onclick="window.location.href='member_notifications.html'" >All</div> 
                  <div class="divider-tabs"></div>
                  <div onclick="window.location.href='member_notifications.html'" >Challenge Requests</div> 
                  <div class="divider-tabs"></div>
